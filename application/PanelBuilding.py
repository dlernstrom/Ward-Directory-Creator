...
class BuildingPanel(ColoredPanel):
    def __init__(self, parent, app_handle):
        ...
        ScheduleGrid.Add(self.SacTime, (1, 2), span=wx.DefaultSpan,
                         flag=wx.ALIGN_RIGHT | wx.TOP | wx.LEFT | wx.BOTTOM,
                         border=10)
        ScheduleGrid.Add(self.spin1, (1, 3), span=wx.DefaultSpan,
        ...
        ScheduleGrid.Add(self.CB_SundaySchoolDisp, (2, 0),
        ...
        if int(self.app_handle.get_conf_val('block.displayss')):
            ...
            self.SSTime.Enable(False)
        ScheduleGrid.Add(self.SSTime, (2, 2), span=wx.DefaultSpan,
                         flag=wx.ALIGN_RIGHT | wx.TOP | wx.LEFT | wx.BOTTOM,
                         border=10)
        ScheduleGrid.Add(self.spin2, (2, 3), span=wx.DefaultSpan,
                         flag=wx.ALIGN_LEFT | wx.TOP | wx.RIGHT | wx.BOTTOM,
                         border=10)
        ...
        ScheduleGrid.Add(self.CB_PriesthoodDisp, (3, 0), span=wx.DefaultSpan,
                         flag=wx.ALIGN_CENTER | wx.ALL, border=10)
        ...
        ScheduleGrid.Add(self.PriesthoodTime, (3, 2), span=wx.DefaultSpan,
                         flag=wx.ALIGN_RIGHT | wx.TOP | wx.LEFT | wx.BOTTOM,
                         border=10)
        ScheduleGrid.Add(self.spin3, (3, 3), span=wx.DefaultSpan,
                         flag=wx.ALIGN_LEFT | wx.TOP | wx.RIGHT | wx.BOTTOM,
                         border=10)
        ...
        self.BuildingBoxSizer = BuildingBoxSizer = wx.StaticBoxSizer(
            BuildingBox, wx.VERTICAL)
